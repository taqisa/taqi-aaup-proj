...
export function NewArrivals() {
  return (
    <section id="arrivals" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12 text-black">New Arrivals</h2>
              ...
              */}
              ...
              ">
                ...
                <div className="flex flex-col items-center w-full">
                  <h3 className="text-xl font-medium text-gray-800 mb-2 font-serif">
                    New Arrivals
                  </h3>
                  ...
                  {/* Button */}
                  <button className="border border-[#00D2D3] text-[#00D2D3] px-6 py-2 text-sm font-medium hover:bg-[#00D2D3] hover:text-white transition-colors duration-300 w-full sm:w-auto">
                    Learn More
                  </button>
                </div>
